...
*   Read and ground your answer in:
    *   docs/002- final_requirements.md
    *   tasks/001- initial_MVP.md
*   MVP: .NET 10 WebAPI + Angular, EF Core + SQLite (dev, single instance acceptable in prod for MVP), ProblemDetails errors, soft delete, pagination/filter/search.
...
*   Tech stack and rationale
    *   Backend: .NET 10 WebAPI, EF Core (SQLite), validation, mapping, logging 
    *   UI: Angular with tailwind css, now dedicated UI library
...
*   Diagrams (use Markdown Mermaid)
    ...
    *   Component diagram (Controllers → Services → Repos → DbContext; front end)  
...
save your results to file tasks/002- tech_design.md